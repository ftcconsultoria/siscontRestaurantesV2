...
class SyncService {
  ...
  Future<void> pull({void Function(double progress)? onProgress}) async {
    ...
    final contactQuery = supabase
        .from('CADE_CONTATO')
        .select(
            'CCOT_CNPJ, CCOT_NOME, CCOT_FANTASIA, CCOT_IE, CCOT_END_CEP, CCOT_END_NOME_LOGRADOURO, CCOT_END_COMPLEMENTO, CCOT_END_QUADRA, CCOT_END_LOTE, CCOT_END_NUMERO, CCOT_END_BAIRRO, CCOT_END_MUNICIPIO, CCOT_END_CODIGO_IBGE, CCOT_END_UF, CCOT_END_LAT, CCOT_END_LON, CEMP_PK, CCOT_TP_PESSOA')
        .order('CCOT_NOME');
    ...
    var query = supabase
        ...
        .select('PDOC_PK, PDOC_UUID, CEMP_PK, PDOC_DT_EMISSAO, PDOC_VLR_TOTAL, CCOT_CNPJ, CCOT_VEND_PK, PDOC_ESTADO_PEDIDO');
